...
import { careersBenefits } from "@/lib/content";
    ...
    <section className="py-20 lg:py-28 bg-[var(--bg-primary)]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <ScrollReveal animation="fade-up" delay={300}>
          <div className="max-w-md mx-auto mb-16">
            <div className="card p-8 text-center">
              ...
              <p className="text-[var(--text-primary)] font-medium mb-1">No open positions</p>
              <p className="text-[var(--text-secondary)] text-sm">Check back later or send us your resume.</p>
            </div>
          </div>
        </ScrollReveal>
        ...
        <div className="text-center mb-10">
          <ScrollReveal animation="fade-up">
            <span className="badge mb-4">Why Join Us</span>
          </ScrollReveal>
          <ScrollReveal animation="fade-up" delay={100}>
            <h2 className="text-3xl sm:text-4xl font-bold text-[var(--text-primary)]">
              Why Hamzah LLC?
