  ...
  return (
    <section className="relative -mt-10 z-10 pb-10 lg:pb-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <ScrollReveal animation="scale" distance={14} duration={500} rootMargin="0px 0px -3% 0px">
          <div className="card bg-[var(--bg-elevated)] p-6 lg:p-8">
              ...
              <div className="space-y-4">
                <div className="grid sm:grid-cols-3 gap-3">
                  {metrics.map((metric) => (
                    <div
                      key={metric.label}
                      className="rounded-xl border border-[var(--border-color)] bg-[var(--bg-primary)] px-4 py-3"
                    >
                ...
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 rounded-xl border border-[var(--border-color)] bg-[var(--bg-primary)] px-4 py-3">
