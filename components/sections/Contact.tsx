    ...
    <section id={sectionId} className="py-20 lg:py-28 bg-[var(--bg-primary)]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-14">
          ...
          {resolvedSubtitle ? (
            <ScrollReveal animation="fade-up" delay={120} distance={14} duration={500} rootMargin="0px 0px -3% 0px">
        ...
        <div className="grid lg:grid-cols-5 gap-10 lg:gap-14">
          <div className="lg:col-span-2 space-y-6">
            ...
            <ScrollReveal animation="fade-right" delay={130} distance={16} duration={500} rootMargin="0px 0px -5% 0px">
          ...
          <div className="lg:col-span-3">
            <ScrollReveal animation="fade-left" delay={120} distance={18} duration={520} rootMargin="0px 0px -5% 0px">
